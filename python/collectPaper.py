    ...
    def __init__(self, __data, pubtype=None):
        ...
        if self.source == 'citations':
            ...
            for link in lowerlinks:
                if 'BibTeX' in link.text:
                    #self.url_scholarbib = link['href']
                    bibtex_soup = _get_soup(link['href'])
                    self.bibtex = bibtex_soup.text
...
def getPaperListByTitle(title):
    search_query = search_pubs_query(title)
